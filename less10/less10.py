...
class CarsBase:  # Создаем родительский абстрактный класс "Машины"
...
class BMW(CarsBase):  # Создаём дочерний класс BMW, который наследуется от родительского класса Машины.
    ...
    def __init__(self, label='BMW', mod='xDrive 35i', capacity=306, fuel_cap=85, fuel_cons=10.1, max_speed=235,
        ...
        """
        super().__init__(label, mod, capacity, fuel_cap, fuel_cons, max_speed, color=color)
...
class Audi(CarsBase):  # Создаём дочерний класс Audi, который наследуется от родительского класса Машины.
...
class Kia(CarsBase):  # Создаём дочерний класс Kia, который наследуется от родительского класса Машины.
